...
* Registros poco organizados: los datos se anotan en hojas o cuadernos, lo que dificulta su búsqueda o actualización.
* Duplicación de productos: al no tener control automatizado, es común registrar el mismo producto más de una vez.
* Errores al ingresar información: escribir a mano puede generar errores en nombres, precios o estados de los productos.
* Falta de control de inventario: no se distingue con claridad cuáles productos están en venta, en bodega o descontinuados.
